            ...
            <Fragment>
                <nav className="navigation">
                    ...
                    <div className="navigation__list">
                        ...
                        <a href={process.env.REACT_APP_WEB_APP_URL} className="navigation__item navigation__item--login">Log in</a>
                    </div>
                ...
                <nav className={showMobileMenu?'navigation__mobile navigation__mobile--transform':'navigation__mobile'}>
                    <div className="navigation__list--mobile">
                        ...
                        <Link to={process.env.REACT_APP_WEB_APP_URL} className="navigation__item navigation__item--login navigation__item--mobile">Log in</Link>
                    </div>
                </nav>
            </Fragment>
        )
